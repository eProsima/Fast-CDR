...
# Get product version.
CDRVERSION=-$(shell $(EPROSIMADIR)/scripts/common_pack_functions.sh printVersionFromCPP include/cpp/cdr/Cdr_version.h)
...
CDR_TARGET_DEBUG_Z_FILE_LINK= libcdrd.a
CDR_TARGET_FILE_LINK= libcdr.so
CDR_TARGET_Z_FILE_LINK= libcdr.a
...
CDR_INCLUDE_DIRS= $(INCLUDE_DIRS) -I$(BASEDIR)/include -I$(BASEDIR)/../Marshalling/include \
		  -I$(EPROSIMADIR)/code

CDR_SRC_CPPFILES= $(BASEDIR)/src/cpp/cdr/Cdr.cpp \
		  $(BASEDIR)/src/cpp/cdr/FastCdr.cpp
...
$(CDR_TARGET_DEBUG): $(CDR_OBJS_DEBUG)
	...
	$(LNK) -s -f $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)/$(CDR_TARGET_DEBUG_FILE) $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)/$(CDR_TARGET_DEBUG_FILE_LINK)

$(CDR_TARGET_DEBUG_Z): $(CDR_OBJS_DEBUG)
	$(AR) -cru $(CDR_TARGET_DEBUG_Z) $(CDR_OBJS_DEBUG)
	$(LNK) -s -f $(CDR_TARGET_DEBUG_Z_FILE) $(BASEDIR)/lib/$(EPROSIMA_TARGET)/$(CDR_TARGET_DEBUG_Z_FILE_LINK)
	$(CP) $(CDR_TARGET_DEBUG_Z) $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)
	$(LNK) -s -f $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)/$(CDR_TARGET_DEBUG_Z_FILE) $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)/$(CDR_TARGET_DEBUG_Z_FILE_LINK)
...
$(CDR_TARGET): $(CDR_OBJS_RELEASE)
	...
	$(LNK) -s -f $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)/$(CDR_TARGET_FILE) $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)/$(CDR_TARGET_FILE_LINK)

$(CDR_TARGET_Z): $(CDR_OBJS_RELEASE)
	$(AR) -cru $(CDR_TARGET_Z) $(CDR_OBJS_RELEASE)
	$(LNK) -s -f $(CDR_TARGET_Z_FILE) $(BASEDIR)/lib/$(EPROSIMA_TARGET)/$(CDR_TARGET_Z_FILE_LINK)
	$(CP) $(CDR_TARGET_Z) $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)
	$(LNK) -s -f $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)/$(CDR_TARGET_Z_FILE) $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)/$(CDR_TARGET_Z_FILE_LINK)
