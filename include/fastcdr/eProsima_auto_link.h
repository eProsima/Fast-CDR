...
*/
	...
	&& defined(FASTCDR_VERSION_MICRO)
        #pragma comment(lib, EPROSIMA_LIB_PREFIX EPROSIMA_STRINGIZE(EPROSIMA_LIB_NAME) EPROSIMA_LIB_DEBUG_TAG "-" EPROSIMA_STRINGIZE(FASTCDR_VERSION_MAJOR) "." EPROSIMA_STRINGIZE(FASTCDR_VERSION_MINOR) "." EPROSIMA_STRINGIZE(FASTCDR_VERSION_MICRO) ".lib")
    #else
